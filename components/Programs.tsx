      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          ...
          <ProgramCard
            icon={
              <svg
                className="w-12 h-12 text-[#FFAA33]"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            title={t("campusLife.programs.prePrimary.title")}
            description={t("campusLife.programs.prePrimary.desc")}
          ...
          <ProgramCard
            icon={
              <svg
                className="w-12 h-12 text-[#00C4B4]"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            title={t("campusLife.programs.primary.title")}
            description={t("campusLife.programs.primary.desc")}
          ...
          <ProgramCard
            icon={
              <svg
                className="w-12 h-12 text-[#3377FF]"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            title={t("campusLife.programs.middle.title")}
            description={t("campusLife.programs.middle.desc")}
...
function ProgramCard({ icon, title, description, gradient }: ProgramCardProps) {
  return (
    <article className="relative bg-white rounded-3xl p-10 shadow-xl transition-transform duration-500 hover:-translate-y-2 hover:scale-105">
      ...
      <h3 className="text-2xl md:text-3xl font-bold text-[#06304A] mt-16 mb-3">
        {title}
      </h3>
